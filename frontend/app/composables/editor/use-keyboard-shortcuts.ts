...
type TextViewShortcutHandlers = Pick<Record<ShortcutCommandId, () => boolean>, 'nextTextField' | 'prevTextField' | 'blurTextField' | 'nextSameIndexField' | 'createGtFromRecognition'>
