...
The virtual keyboard follows the editor color mode automatically:
- Light mode in light editor theme
- Dark mode in dark editor theme

### Position

Keyboard placement:
- Floating overlay near the input field
- Virtual Keyboard panel in the right sidebar
