...
const showBackground = computed(() => !['letter-only', 'splash-screen'].includes(props.variant))
...
const backgroundColor = computed(() => props.variant === 'monochrome' ? 'currentColor' : '#1678E4FF')
...
const strokeColor = computed(() => 'transparent')
</script>
