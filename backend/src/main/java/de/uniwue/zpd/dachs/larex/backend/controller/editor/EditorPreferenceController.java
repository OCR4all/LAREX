...
public class EditorPreferenceController {
    ...
    public record EditorPreferenceDto(
            ...
            String toolbarFloatingOrientation,
            Integer toolbarFloatingX,
            Integer toolbarFloatingY,
        ...
        public static EditorPreferenceDto from(EditorPreference pref) {
            return new EditorPreferenceDto(
                    ...
                    pref.getToolbarFloatingOrientation(),
                    pref.getToolbarFloatingX(),
                    pref.getToolbarFloatingY(),
