...
public interface TaskRepository extends JpaRepository<Task, String> {
    ...
    @Query("""
        ...
        SET t.status = :status,
            ...
            t.completedByUserId = :completedByUserId
        WHERE t.workspaceId = :workspaceId
          AND t.id IN :taskIds
        """)
    int bulkUpdateStatusInWorkspace(
    ...
    @Query("""
        ...
        WHERE t.workspaceId = :workspaceId
          AND t.id IN :taskIds
        """)
    int bulkUpdatePriorityInWorkspace(
            @Param("workspaceId") String workspaceId,
            @Param("taskIds") Collection<String> taskIds,
    ...
    @Modifying
    @Query("DELETE FROM Task t WHERE t.workspaceId = :workspaceId AND t.id IN :taskIds")
