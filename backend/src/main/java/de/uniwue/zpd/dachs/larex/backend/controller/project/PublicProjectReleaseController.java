...
@RestController
@RequestMapping("/public/project-releases")
public class PublicProjectReleaseController {

    private final ProjectPackageService projectPackageService;

    public PublicProjectReleaseController(ProjectPackageService projectPackageService) {
    ...
    private ResponseEntity<Resource> buildResponse(String sharePublicId,
                                                   String authorizationHeader,
                                                   boolean trackUsage) throws IOException {
        ProjectPackageService.SharedReleaseDownload download = projectPackageService.downloadSharedReleasePackage(
                sharePublicId,
                authorizationHeader,
                trackUsage
        );
